...
class OwnerRowDetails extends StatelessWidget {
  // final String ownerName,title,ownerPhotoURL;
 // final void Function()? callOnTap, messageOnTap;
  const OwnerRowDetails({super.key});
        ...
        Row(
          children: [
            ...
            CircleAvatar(
              ...
              backgroundImage: Image.asset(ownerImage).image,
            ),
          ...
          children: [Text("Gary Allen",style: appTheme.textTheme.displayLarge!.copyWith(
            fontWeight: FontWeight.w500,color:houseBlack100
          ),), Text("Owner",style: appTheme.textTheme.displaySmall!.copyWith(
